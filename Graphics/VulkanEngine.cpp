...
void VulkanEngine::InitializePipelines()
{
	...
	if (!LoadShaderModule("../Graphics/Shaders/colored_triangle.frag.spv", &triangleFragShader))
	...
	if (!LoadShaderModule("../Graphics/Shaders/colored_triangle.vert.spv", &triangleVertShader))
