...
std::unique_ptr<leap::graphics::Shader, leap::graphics::ShaderDelete> leap::graphics::shaders::Billboard::GetShader()
{
	...
	pShader->directXVertexData = []()
		{
			...
			vertexDesc[3].SemanticName = "ROTATION";
	...
	pShader->directXDataPath = "Data/Engine/Shaders/Billboard.fx";
