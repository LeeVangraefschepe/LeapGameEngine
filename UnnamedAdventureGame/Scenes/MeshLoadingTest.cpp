...
#include <Utility/GameObjectUtility.h>
...
void unag::MeshLoadingTest::Load(leap::Scene& scene)
{
	...
	leap::GameObjectUtility::CreateFromFBX(fbxMeshObj, "Data/Cube.fbx");
	...
	fbxMeshObj->GetTransform()->SetLocalScale(0.01f, 0.01f, 0.01f);
}